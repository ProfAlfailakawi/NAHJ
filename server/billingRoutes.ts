 ...
 *
 * الخروج من الحساب، تغيير كلمة المرور، وقراءة/طلب ما يخصّ الاشتراك نفسه —
 * لأن تجميد الطريق إلى التجديد يجعل التجميد أبدياً، وتجميد الخروج من حسابٍ
 * لا يُستعمل عقوبةٌ على الشخص لا على المؤسسة.
 */
const ALWAYS_OPEN = [/^\/billing\//, /^\/auth\//];
